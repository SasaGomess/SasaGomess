...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Bebas+Neue&duration=1&pause=1000&color=E9CCF7&width=600&lines=Sou+desenvolvedora+de+software+apaixonada+por+criar+soluções+inovadoras!)](https://git.io/typing-svg)

#
 <table>
  <tr>
    <td>
      <p align="left"> Estudante de Análise de Desenvolvimento de Sistemas, aonde estou aprimorando minhas habilidades em desenvolvimento de software.<br></br> Com foco em Back-end, estou desenvolvendo minhas habilidades em Java, Spring Boot e padrões de projeto.<br></br> Aprimorando minhas habilidades em Java, MySql, Computação em nuvem, banco de dados Oracle.</p>
    </td>
    <td>
      <img align="right" alt="" height="250px" src="https://github.com/user-attachments/assets/f51ca61f-d9ac-43cc-bfba-403a347d05e3">
  </td>
  </tr>
 </table>
</div>
